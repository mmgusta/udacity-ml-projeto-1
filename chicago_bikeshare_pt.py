...
def column_to_list(data, index):
    """
    Função que, dado um index, converte em coluna o dictionary.
    Argumentos:
        param1: Arquivo em forma de dictionary.
...
for item in data_list:
    if item['Gender'].title() == 'Male':
        male += 1
    elif item['Gender'].title() == 'Female':
        female += 1
...
def count_gender(data_list):
    """
      Função que retorna a conta os generos contidos no arquivo.
      Argumentos:
          param1: Arquivo em forma de dictionary.
      Retorna:
          Lista contendo o número de pessoas do sexo masculino e feminino.
...
answer = "Pois existem clientes que não declararam seu sexo."
...
min_trip = trip_duration_list[random.randrange(len(trip_duration_list) - 1)]
max_trip = trip_duration_list[random.randrange(len(trip_duration_list) - 1)]
...
mean_trip /= trip_list_len

center = round(trip_list_len / 2)
